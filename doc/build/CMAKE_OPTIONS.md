# CMake options
**Recent version of this document: https://pythonxm.com/docs/miner/cmake-options**
...
* **`-DWITH_HWLOC=OFF`**
disable [hwloc](https://github.com/pythonxm/pythonxm/issues/1077) support.
...
* **`-DWITH_EMBEDDED_CONFIG=ON`** Enable [embedded](https://github.com/pythonxm/pythonxm/issues/957) config support.
...
* **`-DPYTHONXM_DEPS=<path>`** path to precompiled dependencies https://github.com/pythonxm/pythonxm-deps
