...
pythonxm::Assembly::Id pythonxm::Assembly::parse(const char *assembly, Id defaultValue)
{
...
pythonxm::Assembly::Id pythonxm::Assembly::parse(const rapidjson::Value &value, Id defaultValue)
{
    if (value.IsBool()) {
...
const char *pythonxm::Assembly::toString() const
{
    return asmNames[m_id];
}


rapidjson::Value pythonxm::Assembly::toJSON() const
{
