...
bool pythonxm::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool pythonxm::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t pythonxm::LinuxMemory::read(const char *path)
{
