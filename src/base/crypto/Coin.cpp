...
pythonxm::Algorithm::Id pythonxm::Coin::algorithm(uint8_t blobVersion) const
{
    switch (id()) {
    case MONERO:
...
const char *pythonxm::Coin::name() const
{
...
rapidjson::Value pythonxm::Coin::toJSON() const
{
...
pythonxm::Coin::Id pythonxm::Coin::parse(const char *name)
{
