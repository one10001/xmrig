...
// since 2019.05.16, Version 1.29.0 (Stable) https://github.com/pythonxm/pythonxm/pull/1889
...
pythonxm::Async::Async(Callback callback) : d_ptr(new AsyncPrivate())
{
...
pythonxm::Async::Async(IAsyncListener *listener) : d_ptr(new AsyncPrivate())
{
