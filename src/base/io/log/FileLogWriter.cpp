...
bool pythonxm::FileLogWriter::open(const char *fileName)
{
...
bool pythonxm::FileLogWriter::write(const char *data, size_t size)
{
    if (!isOpen()) {
        return false;
    }
...
bool pythonxm::FileLogWriter::writeLine(const char *data, size_t size)
{
