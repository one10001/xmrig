...
pythonxm::HttpsServer::HttpsServer(const std::shared_ptr<IHttpListener> &listener) :
    m_listener(listener)
{
}


pythonxm::HttpsServer::~HttpsServer()
{
...
bool pythonxm::HttpsServer::setTls(const TlsConfig &config)
{
...
void pythonxm::HttpsServer::onConnection(uv_stream_t *stream, uint16_t)
{
...
void pythonxm::HttpsServer::onRead(uv_stream_t *stream, ssize_t nread, const uv_buf_t *buf)
{
