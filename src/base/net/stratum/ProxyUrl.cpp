...
pythonxm::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const pythonxm::String &pythonxm::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value pythonxm::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
