...
if (WITH_HTTP)
    ...
    add_definitions(/DPYTHONXM_FEATURE_HTTP)
    add_definitions(/DPYTHONXM_FEATURE_API)
else()
    set(HEADERS_BASE_HTTP "")
    set(SOURCES_BASE_HTTP "")
    remove_definitions(/DPYTHONXM_FEATURE_HTTP)
    remove_definitions(/DPYTHONXM_FEATURE_API)
endif()
...
if (WITH_ENV_VARS)
    add_definitions(/DPYTHONXM_FEATURE_ENV)
else()
    remove_definitions(/DPYTHONXM_FEATURE_ENV)
endif()
...
if (WITH_RANDOMX AND WITH_BENCHMARK)
    add_definitions(/DPYTHONXM_FEATURE_BENCHMARK)
    ...
    remove_definitions(/DPYTHONXM_FEATURE_BENCHMARK)
endif()
