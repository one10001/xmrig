if (BUILD_STATIC AND PYTHONXM_OS_UNIX AND WITH_CUDA)
...
if (WITH_CUDA)
    add_definitions(/DPYTHONXM_FEATURE_CUDA)
   ...
   if (WITH_NVML AND NOT APPLE)
       add_definitions(/DPYTHONXM_FEATURE_NVML)
       ...
       remove_definitions(/DPYTHONXM_FEATURE_NVML)
   endif()
   ...
   if (WITH_KAWPOW)
    ...
    remove_definitions(/DPYTHONXM_FEATURE_CUDA)
    remove_definitions(/DPYTHONXM_FEATURE_NVML)
