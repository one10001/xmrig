...
void pythonxm::Blake2bHashRegistersKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void pythonxm::Blake2bHashRegistersKernel::setArgs(cl_mem out, cl_mem in, uint32_t inStrideBytes)
{
