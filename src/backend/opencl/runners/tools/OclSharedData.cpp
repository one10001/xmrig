...
cl_mem pythonxm::OclSharedData::createBuffer(cl_context context, size_t size, size_t &offset, size_t limit)
{
...
uint64_t pythonxm::OclSharedData::adjustDelay(size_t id)
{
    if (m_threads < 2) {
        return 0;
    }
...
uint64_t pythonxm::OclSharedData::resumeDelay(size_t id)
{
    if (m_threads < 2) {
        return 0;
    }
...
void pythonxm::OclSharedData::release()
{
...
void pythonxm::OclSharedData::setResumeCounter(uint32_t value)
{
    if (m_threads < 2) {
        return;
    }
...
void pythonxm::OclSharedData::setRunTime(uint64_t time)
{
...
void pythonxm::OclSharedData::createDataset(cl_context ctx, const Job &job, bool host)
{
    if (m_dataset) {
        return;
    }
