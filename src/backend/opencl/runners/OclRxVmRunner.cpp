...
pythonxm::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


pythonxm::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t pythonxm::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void pythonxm::OclRxVmRunner::build()
{
...
void pythonxm::OclRxVmRunner::execute(uint32_t iteration)
{
...
void pythonxm::OclRxVmRunner::init()
{
