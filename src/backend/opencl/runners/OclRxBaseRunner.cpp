...
pythonxm::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
pythonxm::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void pythonxm::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void pythonxm::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t pythonxm::OclRxBaseRunner::bufferSize() const
{
...
void pythonxm::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void pythonxm::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
