...
pythonxm::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


pythonxm::OclRxJitRunner::~OclRxJitRunner()
{
...
void pythonxm::OclRxJitRunner::execute(uint32_t iteration)
{
...
void pythonxm::OclRxJitRunner::init()
{
...
bool pythonxm::OclRxJitRunner::loadAsmProgram()
{
