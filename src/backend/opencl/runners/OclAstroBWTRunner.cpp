...
pythonxm::OclAstroBWTRunner::OclAstroBWTRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
pythonxm::OclAstroBWTRunner::~OclAstroBWTRunner()
{
...
size_t pythonxm::OclAstroBWTRunner::bufferSize() const
{
...
void pythonxm::OclAstroBWTRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void pythonxm::OclAstroBWTRunner::set(const Job &job, uint8_t *blob)
{
...
void pythonxm::OclAstroBWTRunner::build()
{
    OclBaseRunner::build();
...
void pythonxm::OclAstroBWTRunner::init()
{
    OclBaseRunner::init();
