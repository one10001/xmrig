...
std::vector<pythonxm::OclPlatform> pythonxm::OclPlatform::get()
{
...
void pythonxm::OclPlatform::print()
{
...
rapidjson::Value pythonxm::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<pythonxm::OclDevice> pythonxm::OclPlatform::devices() const
{
...
pythonxm::String pythonxm::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


pythonxm::String pythonxm::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


pythonxm::String pythonxm::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


pythonxm::String pythonxm::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


pythonxm::String pythonxm::OclPlatform::version() const
{
