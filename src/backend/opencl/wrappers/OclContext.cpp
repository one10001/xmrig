...
pythonxm::OclContext::OclContext(const OclDevice &device)
{
...
pythonxm::OclContext::~OclContext()
{
    if (m_ctx) {
...
bool pythonxm::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
