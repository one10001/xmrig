if (BUILD_STATIC AND PYTHONXM_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    ...
    add_definitions(/DPYTHONXM_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/DPYTHONXM_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/DPYTHONXM_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/DPYTHONXM_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (PYTHONXM_OS_WIN OR PYTHONXM_OS_LINUX))
        add_definitions(/DPYTHONXM_FEATURE_ADL)
       ...
       remove_definitions(/DPYTHONXM_FEATURE_ADL)
    endif()
else()
    remove_definitions(/DPYTHONXM_FEATURE_OPENCL)
    remove_definitions(/DPYTHONXM_FEATURE_ADL)
