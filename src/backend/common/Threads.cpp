...
template <class T>
const T &pythonxm::Threads<T>::get(const String &profileName) const
{
    static T empty;
...
template <class T>
size_t pythonxm::Threads<T>::read(const rapidjson::Value &value)
{
...
template <class T>
pythonxm::String pythonxm::Threads<T>::profileName(const Algorithm &algorithm, bool strict) const
{
...
template <class T>
void pythonxm::Threads<T>::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
