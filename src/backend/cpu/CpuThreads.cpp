...
pythonxm::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
pythonxm::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool pythonxm::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value pythonxm::CpuThreads::toJSON(rapidjson::Document &doc) const
{
