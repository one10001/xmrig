...
std::shared_ptr<pythonxm::Msr> pythonxm::Msr::get()
{
...
bool pythonxm::Msr::write(uint32_t reg, uint64_t value, int32_t cpu, uint64_t mask, bool verbose)
{
...
pythonxm::MsrItem pythonxm::Msr::read(uint32_t reg, int32_t cpu, bool verbose) const
{
    uint64_t value = 0;
