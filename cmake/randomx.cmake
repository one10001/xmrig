if (WITH_RANDOMX)
    add_definitions(/DPYTHONXM_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (NOT PYTHONXM_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (PYTHONXM_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT PYTHONXM_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (PYTHONXM_OS_WIN OR PYTHONXM_OS_LINUX))
        add_definitions(/DPYTHONXM_FEATURE_MSR)
        add_definitions(/DPYTHONXM_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/DPYTHONXM_FEATURE_MSR)
        remove_definitions(/DPYTHONXM_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()

    if (WITH_PROFILING)
        add_definitions(/DPYTHONXM_FEATURE_PROFILING)

        list(APPEND HEADERS_CRYPTO src/crypto/rx/Profiler.h)
        list(APPEND SOURCES_CRYPTO src/crypto/rx/Profiler.cpp)
    endif()
else()
    remove_definitions(/DPYTHONXM_ALGO_RANDOMX)
endif()
