...
::
:: Format:
::	pythonxm.exe -o <node address>:<node port> -a rx/0 -u <wallet address> --daemon
::
:: Fields:
...
cd %~dp0
pythonxm.exe -o node.xmr.to:18081 -a rx/0 -u 44ucr5iSqUjCR6m93Gu9ssJC9W1yWLGz1fZbAChLXG1QPnFD5bsTXKJAQEk8dHKDWx8hYJQ5ELqg9DJKNA1oRoNZKCGyn1p --daemon
pause
