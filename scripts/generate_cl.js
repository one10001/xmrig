...
function cn()
{
    ...
    fs.writeFileSync('cryptonight_cl.h', text2h(cn, 'pythonxm', 'cryptonight_cl'));
}
...
function cn_r()
{
    ...
    fs.writeFileSync('cryptonight_r_cl.h', text2h_bundle('pythonxm', items));
}
...
function rx()
{
    ...
    fs.writeFileSync('randomx_cl.h', text2h(rx, 'pythonxm', 'randomx_cl'));
}
...
function astrobwt()
{
    ...
    fs.writeFileSync('astrobwt_cl.h', text2h(astrobwt, 'pythonxm', 'astrobwt_cl'));
}
...
function kawpow()
{
    ...
    fs.writeFileSync('kawpow_cl.h', text2h(kawpow, 'pythonxm', 'kawpow_cl'));
    fs.writeFileSync('kawpow_dag_cl.h', text2h(kawpow_dag, 'pythonxm', 'kawpow_dag_cl'));
}
